...
let emailLengthChecker = (email) => {
    ...
    if (!email) return false; // Return error
        ...
        else return true; // Return as valid e-mail
    }
};
...
let usernameLengthChecker = (username) => {
    ...
    if (!username) return false; // Return error
    else {
        // Check length of username string
        if (username.length < 3 || username.length > 15) return false; // Return error if does not meet length requirement
        else return true; // Return as valid username
    }
};
...
let passwordLengthChecker = (password) => {
    ...
    if (!password) return false; // Return error
    else {
        // Check password length
        if (password.length < 8 || password.length > 35) return false; // Return error if passord length requirement is not metelse {
